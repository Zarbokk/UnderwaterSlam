...
//            indexOfLastKeyframe = slamToolsRos::getLastIntensityKeyframe(this->graphSaved);
            ...
            slamToolsRos::calculateStartAndEndIndexForVoxelCreation(this->graphSaved.getVertexList()->back().getKey()-5,indexStart,indexEnd,this->graphSaved);
            ...
            this->initialGuessTransformation =
                    (this->graphSaved.getVertexList()->at(indexEnd).getTransformation().inverse() *
            ...
            slamToolsRos::saveResultingRegistration(indexEnd, indexStart,
...
//                      << std::endl;
            ...
            std::cout << this->graphSaved.getVertexList()->at(indexEnd).getTransformation().inverse() *
